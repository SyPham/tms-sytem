...
export class HistoryComponent implements OnInit {
  ...
  constructor(
   ...
   public dueDateAccessor = (field: object, data: { Entity: {DueDate: string} }, column: object): string => {
    ...
    filterDateRange() {
      const start = this.calendarsService.toFormatDate(this.daterange[0]);
      const end = this.calendarsService.toFormatDate(this.daterange[1]);
    ...
    filterDateRangeByDueDateTime() {
      const start = this.calendarsService.toFormatDate(this.daterangeForDueDateTime[0]);
      const end = this.calendarsService.toFormatDate(this.daterangeForDueDateTime[1]);
    ...
    contextMenuOpen(arg?: any): void {
      ...
      const data = arg.rowInfo.rowData.Entity;
      if (data.VideoStatus) {
        document
